...
**Таблиця 1 — Приклади інформації, яка відповідає та не відповідає формі відкритих даних**
...
**Рисунок 1 — Порівняння звичайної таблиці та CSV-файлу**
...
**Рисунок 2 — Схематичне зображення структури файлу JSON**
